    ...
    return SizedBox(
      ...
      child: ValueListenableBuilder<FilterData>(
        ...
        builder: (context, filter, child) {
          final _selected = filter.selectedMainCategory;
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  // Update global state instead of local setState
                  globalFilterState.value = filter.copyWith(
                    selectedMainCategory: category['label'],
                  );
                },
